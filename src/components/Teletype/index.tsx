...
class Teletype extends Component<TeletypeProps, TeletypeState> {
  ...
  public render(): ReactElement {
    ...
    return (
      <div className={css}>
        ...
        <span className="cursor" ref={this._cursorRef}>
          {cursor}
        </span>
  ...
  public componentDidUpdate(
    prevProps: TeletypeProps,
    prevState: TeletypeState,
  ): void {
  ...
  private _animate(): void {
    ...
    this._animateTimerId = window.setTimeout(
      this._updateState,
      this._cursorInterval,
    );
  }
